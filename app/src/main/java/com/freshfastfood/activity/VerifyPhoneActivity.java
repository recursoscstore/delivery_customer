...
public class VerifyPhoneActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMob.setText("Te hemos enviado un SMS el " + phonecode + " " + phonenumber + "\n con código de verificación de 6 dígitos");
        try {
            new CountDownTimer(60000, 1000) {
                @Override
                public void onTick(long millisUntilFinished) {
                    long seconds = TimeUnit.MILLISECONDS.toSeconds(millisUntilFinished);
                    btnTimer.setText(seconds + " Espere unos segundos");
                }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            user1.setId("0");
            user1.setName("User");
            user1.setEmail("user@demo.com");
            user1.setMobile("+51942520335");
